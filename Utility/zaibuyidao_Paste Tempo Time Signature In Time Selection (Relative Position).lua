-- @description Paste Tempo/Time Signature In Time Selection (Relative Position)
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   + New Script
...
reaper.Undo_EndBlock("Paste Tempo/Time Signature In Time Selection (Relative Position)", -1)
reaper.PreventUIRefresh(-1)
