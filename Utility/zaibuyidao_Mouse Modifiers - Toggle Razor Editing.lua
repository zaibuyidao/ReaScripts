-- @description Mouse Modifiers - Toggle Razor Editing
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   New Script
...
reaper.SetToggleCommandState(sectionID, razor_editing, 1)
reaper.RefreshToolbar2(sectionID, cmdID)

reaper.SetMouseModifier('MM_CTX_TRACK',0,'25 m') -- Select razor edit area
reaper.SetMouseModifier('MM_CTX_ITEM',0,'62 m') -- Select razor edit area