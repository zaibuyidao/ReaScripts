-- @description Toggle Solo for Specific Track
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   New Script
...
function CheckShortcutSetting()
    local shortcutSetting = reaper.GetResourcePath() .. '/Scripts/zaibuyidao Scripts/Items Editing/zaibuyidao_Toggle Solo for Specific Track Setting.lua'
