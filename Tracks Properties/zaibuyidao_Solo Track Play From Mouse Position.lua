...
local function SaveSoloTracks(t) -- 保存Solo的軌道
    ...
    reaper.SetExtState("SoloTrackPlayFromMousePosition", "SoloTrackRestores", table.serialize(t), false)
end

local function RestoreSoloTracks(t) -- 恢復Solo的軌道状态
    t = getSavedData("SoloTrackPlayFromMousePosition", "SoloTrackRestores")
    for i = 1, #t do
