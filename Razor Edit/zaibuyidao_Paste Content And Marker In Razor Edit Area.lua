-- @description Paste Content And Marker In Razor Edit Area
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   + New Script
...
local function pasteMarkersAndRegions()
  ...
  for _, marker in ipairs(markers) do
    ...
    if not marker[1] then
      ...
      marker[5] = markerId
      reaper.AddProjectMarker2(0, marker[1], newStart, 0, name, marker[5], marker[6])
    end
  end
...
reaper.Undo_EndBlock("Paste Content And Marker In Razor Edit Area", -1)
reaper.PreventUIRefresh(-1)
