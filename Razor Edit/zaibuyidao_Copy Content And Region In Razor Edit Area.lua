-- @description Copy Content And Region In Razor Edit Area
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   + New Script
...
local function copyMarkersAndRegions()
    ...
    -- print("剃刀编辑开始: " .. timeSelectionStart .. ", 结束: " .. timeSelectionEnd)
    ...
    for i = 0, numMarkers - 1 do
        ...
        if (isRegion and position >= timeSelectionStart and regionEnd <= timeSelectionEnd) then
            copied = copied + 1
