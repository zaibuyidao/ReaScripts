...
function main()
    for take, _ in pairs(getTakes) do
        amount = reaper.GetExtState("RandomNoteEnds", "Parameters")
        ...
        reaper.SetExtState("RandomNoteEnds", "Parameters", amount, false)
