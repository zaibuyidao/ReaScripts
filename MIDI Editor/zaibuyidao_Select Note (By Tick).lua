...
userOK, dialog_ret_vals = reaper.GetUserInputs("Select Note By Tick", 4, "Min Tick,Max Tick,Min Beat,Max Beat", "0,1919,1,99")
...
function MEAS()
  for i = 0,  notes-1 do
    ...
    if sel == true then
	  local retval, Bar_Start_QN, Bar_End_QN = reaper.TimeMap_QNToMeasures(0, newstart) -- retval为小节
...
script_title = "Select Note By Tick"
