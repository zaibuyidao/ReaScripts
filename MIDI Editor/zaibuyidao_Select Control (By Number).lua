--[[
 * ReaScript Name: Select Control (By Number)
...
userOK, dialog_ret_vals = reaper.GetUserInputs("Select Control By Number", 2, "Min,Max", "0,127")
...
script_title = "Select Control (By Number)"
