-- @description Random Note Durations
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   New Script
...
function main()
    for take, _ in pairs(getTakes) do
        amount = reaper.GetExtState("RandomNoteDurations", "Parameters")
        ...
        reaper.SetExtState("RandomNoteDurations", "Parameters", amount, false)
