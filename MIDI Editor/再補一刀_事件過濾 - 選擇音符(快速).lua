...
user_ok, dialog_ret_vals = reaper.GetUserInputs("選擇音符(快速)", 13, "音高,,力度,,時值,,通道,,拍子,,嘀嗒,,輸入1以恢復默認設置,", min_key ..','.. max_key ..','.. min_vel ..','.. max_vel ..','.. min_dur ..','.. max_dur ..','.. min_chan ..','.. max_chan ..','.. min_meas ..','.. max_meas ..','.. min_tick ..','.. max_tick ..','.. reset)
...
reaper.Undo_EndBlock("事件過濾 - 選擇音符(快速)", -1)
reaper.PreventUIRefresh(-1)
