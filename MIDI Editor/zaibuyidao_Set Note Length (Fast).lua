--[[
 * ReaScript Name: Set Note Length (Fast)
 * Version: 1.0
 * Author: zaibuyidao
...
user_ok, tick = reaper.GetUserInputs("Set Note Length (Fast)", 1, "Enter A Tick", tick)
...
reaper.Undo_EndBlock("Set Note Length (Fast)", -1)
