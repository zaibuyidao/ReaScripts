...
function Main()
  ...
  local user_ok, userInputsCSV = reaper.GetUserInputs("Insert Bank/Program Select", 2, "Bank,Program Change", BANK ..','.. PC)
  ...
  elseif not tonumber(BANK) or not tonumber(PC) then
    BANK = "0"
    PC = "0"
    reaper.SetExtState("BankProgramSelect", "BANK", BANK, false)
    reaper.SetExtState("BankProgramSelect", "PC", PC, false)
