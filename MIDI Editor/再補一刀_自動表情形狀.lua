...
local user_ok, user_input_csv = reaper.GetUserInputs("自動表情形狀", 6, "CC編號,最小值,最大值,速度(0=慢 1=快),開始弧度(-100至100),結束弧度(-100至100),extrawidth=5", cc_num..','..val_01..','.. val_02..','.. speed..','..bezier_in..','.. bezier_out)
