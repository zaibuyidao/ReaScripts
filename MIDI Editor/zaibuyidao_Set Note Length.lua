...
function main()
    ...
    tick = reaper.GetExtState("SetNoteLengthArrange", "Ticks")
    if (tick == "") then tick = "10" end
    user_ok, tick = reaper.GetUserInputs("Set Note Length", 1, "Enter A Tick", tick)
    reaper.SetExtState("SetNoteLengthArrange", "Ticks", tick, false)
