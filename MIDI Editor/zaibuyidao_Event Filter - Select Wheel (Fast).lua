--[[
 * ReaScript Name: Event Filter - Select Wheel (Fast)
 * Version: 1.0
 * Author: zaibuyidao
...
user_ok, dialog_ret_vals = reaper.GetUserInputs("Select Wheel (Fast)", 9, "Wheel,,Channel,,Beat,,Tick,,Enter 1 to restore default settings,", min_val ..','.. max_val ..','.. min_chan ..','.. max_chan ..','.. min_meas ..','.. max_meas ..','.. min_tick ..','.. max_tick ..','.. reset)
...
reaper.Undo_EndBlock("Select Wheel (Fast)", -1)
reaper.PreventUIRefresh(-1)
