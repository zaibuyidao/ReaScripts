-- @description Instant Solo Note from Edit Cursor
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   New Script
...
local function stash_save_take_events(take)
  ...
  reaper.SetExtState("InstantSoloNotefromEditCursor", tostring(take), encodedStr, false)
end

local function stash_apply_take_events(take)
  local base64Str = reaper.GetExtState("InstantSoloNotefromEditCursor", tostring(take))
