 ...
 * Reference: kawa_MIDI_StrokeDown.lua
 * REAPER: 6.0
--]]
...
function createMIDIFunc3(I)
    ...
    function e:getMidiNotes()
        ...
        local i = {}
        local o = {}
        local p, r, a, n, t, d, l, c = reaper.MIDI_GetNote(self.take, 0)
        local e = 0
        while p do
            _, _, _, n, t, _, _, _ = reaper.MIDI_GetNote(self.take, e)
            local s = {
                selection = r,
                mute = a,
                startQn = n,
            ...
            table.insert(i, s)
            if (r == true) then table.insert(o, s) end
            e = e + 1
            p, r, a, n, t, d, l, c = reaper.MIDI_GetNote(self.take, e)
    ...
    function e:insertMidiNote(n, o, e, a, i, r, l)
        local t = e
        local e = a
        local a = o
        local i = i or false
    ...
    function e:_insertNoteToMediaItem(e, o)
        ...
        local d = e.mute
        local a = reaper.MIDI_GetPPQPosFromProjQN(t, e.startQn)
        local r = reaper.MIDI_GetPPQPosFromProjQN(t, e.endQn)
        local i = e.chan
        local c = e.pitch
        local s = e.vel
        local n = 0
        ...
        reaper.MIDI_InsertNote(t, l, d, a, r - n, i, c, s, true)
    end
...
local function o(t)
    local n = createMIDIFunc3()
    local e = n:detectTargetNote()
    if (#e < 1) then return end
    reaper.Undo_BeginBlock()
    local o = t or 10
    local e = i(e)
    for e, t in pairs(e) do
        table.sort(t.notes, function(e, t) return (e.pitch < t.pitch) end)
        for n, e in ipairs(t.notes) do
            e.startQn = e.startQn + o * (#t.notes - n)
    ...
    n:correctOverWrap()
    reaper.Undo_EndBlock(r, -1)
end
local userOK, tick = reaper.GetUserInputs('STRUM-IT', 1, 'Up', '4')
