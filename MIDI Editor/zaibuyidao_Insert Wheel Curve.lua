...
local user_ok, user_input_CSV = reaper.GetUserInputs("Insert Wheel Curve", 6, "Starting value 起始點,Highest value 最高點,Repetitions 重複,Length 長度,Points 點數,Shape 形狀 (0-3)", bottom ..','.. top ..','.. times .. "," .. length .. "," .. num .. "," .. shape)
