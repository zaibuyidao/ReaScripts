...
if language == "简体中文" then
  title = "插入揉弦"
  captions_csv = "起始点:,最高点:,重复:,长度:,点数:,模式(1=正弦波 2=三角波):"
elseif language == "繁體中文" then
  title = "插入揉弦"
  captions_csv = "起始點:,最高點:,重複:,長度:,點數:,模式(1=正弦波 2=三角波):"
else
  title = "Insert Vibrato"
  captions_csv = "Starting value:,Highest value:,Repetitions:,Length:,Points:,Mode (1=Sine 2=Triangle):"
end
...
if times < 1 or shape > 2 then return reaper.SN_FocusMIDIEditor() end
