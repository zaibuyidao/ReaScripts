-- @description Transform CC (For Selected CC)
-- @version 1.1.1
-- @author zaibuyidao
-- @changelog
...
local uok, uinput = reaper.GetUserInputs(title, 1, captions_csv, cc_new)
cc_new = uinput:match("(.*)")
if not uok or not tonumber(cc_new) then return reaper.SN_FocusMIDIEditor() end
