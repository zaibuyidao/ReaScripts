...
function main()
  ...
  local user_ok, user_input_csv = reaper.GetUserInputs("力度縮放(多軌)", 3, "開始,結束,0=絕對值 1=百分比", vel_start..','..vel_end..','.. toggle)
...
main()
reaper.Undo_EndBlock("力度縮放(多軌)", 0)
