-- @description Trim Note Right Edge (Fast)
-- @version 1.0.4
-- @author zaibuyidao
...
local moveDistance = reaper.GetExtState("TrimNoteRightEdgeFast", "MoveDistance")
if (moveDistance == "") then moveDistance = "10" end

uok, uinput = reaper.GetUserInputs("Trim Note Right Edge (Fast)", 1, "Enter A Tick", moveDistance)
...
reaper.SetExtState("TrimNoteRightEdgeFast", "MoveDistance", moveDistance, false)
