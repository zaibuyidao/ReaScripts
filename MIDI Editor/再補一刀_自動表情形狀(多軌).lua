...
local user_ok, user_input = reaper.GetUserInputs("自動表情形狀(多軌)", 5, "CC編號,最小值,最大值,開始弧度(-100至100),結束弧度(-100至100),extrawidth=5", cc_num..','..val_01..','.. val_02..','..bezier_in..','.. bezier_out)
if not user_ok then return reaper.SN_FocusMIDIEditor() end
cc_num, val_01, val_02, bezier_in, bezier_out = user_input:match("(.*),(.*),(.*),(.*),(.*)")
...
reaper.Undo_EndBlock("自動表情形狀(多軌)", 0)
