...
local user_ok, user_input_csv = reaper.GetUserInputs("Auto Expression Shape (Multitrack)", 6, "CC number,Min value,Max value,Speed(0=Slow 1=Fast),Bezier in(-100 - 100),Bezier out(-100 - 100),extrawidth=5", cc_num..','..val_01..','.. val_02..','.. speed..','..bezier_in..','.. bezier_out)
