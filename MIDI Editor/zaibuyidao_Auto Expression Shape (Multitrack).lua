...
local user_ok, user_input_csv = reaper.GetUserInputs("Auto Expression Shape (Multitrack)", 5, "CC number,Minimum value,Max value,Bezier in(-100 - 100),Bezier out(-100 - 100),extrawidth=5", cc_num..','..val_01..','.. val_02..','..bezier_in..','.. bezier_out)
