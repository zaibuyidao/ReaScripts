--[[
 * ReaScript Name: Select Bottom Notes In Chord (Leave Single Notes Selected)
...
SelectBottomNotes()
reaper.Undo_EndBlock("Select Bottom Notes In Chord (Leave Single Notes Selected)", 0)
