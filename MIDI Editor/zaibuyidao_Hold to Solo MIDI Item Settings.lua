-- @description Hold to Solo MIDI Item Settings
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   New Script
...
function remove_specific_section(filepath, section_to_remove)
  ...
  if section_removed then
    ...
    reaper.SetExtState("HOLD_TO_SOLO_MIDI_ITEM_SETTINGS", "VirtualKey", "", true)
  end
end
...
if remove == "y" then
  ...
  remove_specific_section(ext_ini_path, 'HOLD_TO_SOLO_MIDI_ITEM_SETTINGS')
  return
end
