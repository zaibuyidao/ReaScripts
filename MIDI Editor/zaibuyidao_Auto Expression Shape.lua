-- @description Auto Expression Shape
-- @version 1.2.2
-- @author zaibuyidao
-- @changelog
...
local cc_num = reaper.GetExtState("AUTO_EXPRESSION_SHAPE", "CC")
local val_01 = reaper.GetExtState("AUTO_EXPRESSION_SHAPE", "Val1")
local val_02 = reaper.GetExtState("AUTO_EXPRESSION_SHAPE", "Val2")
local speed = reaper.GetExtState("AUTO_EXPRESSION_SHAPE", "Speed")
local bezier_in = reaper.GetExtState("AUTO_EXPRESSION_SHAPE", "BezierIn")
local bezier_out = reaper.GetExtState("AUTO_EXPRESSION_SHAPE", "BezierOut")
local flag = 0
...
reaper.SetExtState("AUTO_EXPRESSION_SHAPE", "CC", cc_num, false)
reaper.SetExtState("AUTO_EXPRESSION_SHAPE", "Val1", val_01, false)
reaper.SetExtState("AUTO_EXPRESSION_SHAPE", "Val2", val_02, false)
reaper.SetExtState("AUTO_EXPRESSION_SHAPE", "Speed", speed, false)
reaper.SetExtState("AUTO_EXPRESSION_SHAPE", "BezierIn", bezier_in, false)
reaper.SetExtState("AUTO_EXPRESSION_SHAPE", "BezierOut", bezier_out, false)
