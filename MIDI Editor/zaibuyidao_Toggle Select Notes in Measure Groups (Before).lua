...
-- 主函数
local retval, retvals_csv = reaper.GetUserInputs(title, 1, lable, "2")
if not retval then return end

local selectLength = tonumber(retvals_csv)
if not selectLength then return end

reaper.Undo_BeginBlock()

local startMeasure, endMeasure = getStartEndMeasures()
selectNotesBasedOnUserInput(startMeasure, endMeasure, selectLength)
