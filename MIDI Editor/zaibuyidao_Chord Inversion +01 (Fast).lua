...
function moveUp(eventPairs)
    ...
    local overlayTone -- 决定最后叠在顶部音符的音调
    ...
    for i, eventPair in ipairs(eventPairs) do
        -- Msg("changed start " .. eventPair[1].pitch .. " to " .. newPitch[eventPair[1].pitch])
        -- Msg("changed end " .. eventPair[2].pitch .. " to " .. newPitch[eventPair[2].pitch])
