...
local user_ok, user_input_csv = reaper.GetUserInputs("Insert Tremolo", 5, "CC Number,1,2,Repetition,Interval", cc_num..','..cc_begin..','.. cc_end..','..cishu..','.. tick)
...
reaper.Undo_EndBlock("Insert Tremolo", -1)
