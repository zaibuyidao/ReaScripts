--[[
 * ReaScript Name: Random Notes Durations
 * Version: 1.0
 * Author: zaibuyidao
...
function Main()
    ...
    amount = reaper.GetExtState("RandomNotesDurations", "RandomNotes")
    if (amount == "") then amount = "3" end
    user_ok, amount = reaper.GetUserInputs("Random Notes Durations", 1, "Value", amount)
    amount = tonumber(amount)
    reaper.SetExtState("RandomNotesDurations", "RandomNotes", amount, false)
...
local title = "Random Notes Durations"
