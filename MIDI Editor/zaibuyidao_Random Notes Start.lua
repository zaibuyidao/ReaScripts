--[[
 * ReaScript Name: Random Notes Start
 * Version: 1.0
 * Author: zaibuyidao
...
function Main()
    ...
    amount = reaper.GetExtState("RandomNotesStart", "RandomNotes")
    if (amount == "") then amount = "3" end
    user_ok, amount = reaper.GetUserInputs("Random Notes Start", 1, "Value", amount)
    amount = tonumber(amount)
    reaper.SetExtState("RandomNotesStart", "RandomNotes", amount, false)
