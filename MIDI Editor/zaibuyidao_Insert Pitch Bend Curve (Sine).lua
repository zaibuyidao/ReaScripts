...
function Main()
  ...
  local uok, uinput = reaper.GetUserInputs("Insert Pitch Bend Curve (Sine)", 5, "Starting value 起始點,Highest value 最高點,Repetitions 重複,Length 長度,Points 點數", bottom ..','.. top ..','.. times .. "," .. length .. "," .. num)
  ...
  reaper.Undo_EndBlock("Insert Pitch Bend Curve (Sine)", -1)
