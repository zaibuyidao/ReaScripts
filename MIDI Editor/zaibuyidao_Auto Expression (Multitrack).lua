-- @description Auto Expression (Multitrack)
-- @version 1.3.3
-- @author zaibuyidao
-- @changelog
...
cc_number = reaper.GetExtState("AUTO_EXPRESSION_MULTI", "CC_Number")
min_val = reaper.GetExtState("AUTO_EXPRESSION_MULTI", "Begin")
max_val = reaper.GetExtState("AUTO_EXPRESSION_MULTI", "End")
...
reaper.SetExtState("AUTO_EXPRESSION_MULTI", "CC_Number", cc_number, false)
reaper.SetExtState("AUTO_EXPRESSION_MULTI", "Begin", min_val, false)
reaper.SetExtState("AUTO_EXPRESSION_MULTI", "End", max_val, false)
