...
user_ok, dialog_ret_vals = reaper.GetUserInputs("選擇彎音", 9, "彎音,,通道,,拍子,,嘀嗒,,輸入1以恢復默認設置,", min_val ..','.. max_val ..','.. min_chan ..','.. max_chan ..','.. min_meas ..','.. max_meas ..','.. min_tick ..','.. max_tick ..','.. reset)
