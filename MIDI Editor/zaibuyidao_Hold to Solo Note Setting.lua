-- @description Hold to Solo Note Setting
-- @version 1.0.2
-- @author zaibuyidao
-- @changelog
...
function remove_specific_section(filepath, section_to_remove)
  ...
  if section_removed then
    ...
    reaper.SetExtState("HOLD_TO_SOLO_NOTE_SETTING", "VirtualKey", "", true)
  end
end
...
if remove == "y" then
  ...
  remove_specific_section(ext_ini_path, 'HOLD_TO_SOLO_NOTE_SETTING')
  return
end
...
reaper.SetExtState("HOLD_TO_SOLO_NOTE_SETTING", "VirtualKey", key, true)
