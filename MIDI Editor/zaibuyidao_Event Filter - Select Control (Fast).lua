--[[
 * ReaScript Name: Event Filter - Select Control (Fast)
 * Version: 1.0
 * Author: zaibuyidao
...
user_ok, dialog_ret_vals = reaper.GetUserInputs("Select Control (Fast)", 11, "Number,,Value,,Channel,,Beat,,Tick,,Enter 1 to restore default settings,", min_num ..','.. max_num ..','.. min_val ..','.. max_val ..','.. min_chan ..','.. max_chan ..','.. min_meas ..','.. max_meas ..','.. min_tick ..','.. max_tick ..','.. reset)
...
reaper.Undo_EndBlock("Select Control (Fast)", -1)
reaper.PreventUIRefresh(-1)
