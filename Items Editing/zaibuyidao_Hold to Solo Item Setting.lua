...
local title = "Hold to Solo Item Settings"
local lable = "Enter (0-9, A-Z, use ';;' for ',' or .)"
local err_title = "This key can't be set. Please choose another."
