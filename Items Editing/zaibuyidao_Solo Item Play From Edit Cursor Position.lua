--[[
 * ReaScript Name: Solo Item Play From Edit Cursor Position
 * Version: 1.0.1
 * Author: zaibuyidao
...
function SaveMutedItems(t)
    ...
    reaper.SetExtState("SoloItemPlayFromEditCursorPosition", "MutedItemRestores", table.serialize(t), false)
end

function RestoreMutedItems(t)
    t = getSavedData("SoloItemPlayFromEditCursorPosition", "MutedItemRestores")
    for i = 1, #t do
...
function SaveSoloTracks(t)
    ...
    reaper.SetExtState("SoloItemPlayFromEditCursorPosition", "SoloTrackRestores", table.serialize(t), false)
end

function RestoreSoloTracks(t)
    t = getSavedData("SoloItemPlayFromEditCursorPosition", "SoloTrackRestores")
    for i = 1, #t do
