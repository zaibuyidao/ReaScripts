...
function SaveMutedItems(t)
    ...
    reaper.SetExtState("SoloItemPlayFromMousePosition", "MutedItemRestores", table.serialize(t), false)
end

function RestoreMutedItems(t)
    t = getSavedData("SoloItemPlayFromMousePosition", "MutedItemRestores")
    for i = 1, #t do
...
function SaveSoloTracks(t)
    ...
    reaper.SetExtState("SoloItemPlayFromMousePosition", "SoloTrackRestores", table.serialize(t), false)
end

function RestoreSoloTracks(t)
    t = getSavedData("SoloItemPlayFromMousePosition", "SoloTrackRestores")
    for i = 1, #t do
