-- @description Paste Items And Region In Time Selection (Relative Position)
-- @version 1.0
-- @author zaibuyidao
-- @changelog
--   + New Script
...
local function pasteMarkersAndRegions()
  ...
  for _, marker in ipairs(markers) do
    ...
    if marker[1] then
      ...
      regionId = regionId + 1
      marker[5] = regionId
      reaper.AddProjectMarker2(0, true, newStart, newEnd, name, marker[5], marker[6])
    end
  end
...
main() -- 再粘贴媒体对象
reaper.Undo_EndBlock("Paste Items And Region In Time Selection (Relative Position)", -1)
reaper.PreventUIRefresh(-1)
