--[[
 * ReaScript Name: Humanize Take Pitch
 * Version: 1.0
 * Author: zaibuyidao
...
if count_sel_items > 0 then
  local retval, retvals_csv = reaper.GetUserInputs('Humanize Take Pitch', 1, 'Strength (semitones):', '')
...
reaper.Undo_EndBlock('Humanize Take Pitch', -1)
reaper.PreventUIRefresh(-1)
