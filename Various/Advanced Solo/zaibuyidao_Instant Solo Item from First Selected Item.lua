...
function SaveMutedItems()
    ...
    saveData("InstantSoloItemfromFirstSelectedItem", "MutedItemRestores", mutedItems)
end

-- 恢复静音状态的 items
function RestoreMutedItems()
    local mutedItems = getSavedData("InstantSoloItemfromFirstSelectedItem", "MutedItemRestores")
...
function SaveSoloTracks()
    ...
    saveData("InstantSoloItemfromFirstSelectedItem", "SoloTrackRestores", soloTracks)
end

function RestoreSoloTracks()
    local soloTracks = getSavedData("InstantSoloItemfromFirstSelectedItem", "SoloTrackRestores")
