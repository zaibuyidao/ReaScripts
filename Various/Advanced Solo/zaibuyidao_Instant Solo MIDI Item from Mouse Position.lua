...
function SaveMutedItems()
    ...
    saveData("InstantSoloMIDIItemfromMousePosition", "MutedItemRestores", mutedItems)
end

-- 恢复静音状态的 items
function RestoreMutedItems()
    local mutedItems = getSavedData("InstantSoloMIDIItemfromMousePosition", "MutedItemRestores")
