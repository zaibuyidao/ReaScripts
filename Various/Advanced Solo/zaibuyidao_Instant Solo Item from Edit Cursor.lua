...
function SaveMutedItems()
    ...
    saveData("InstantSoloItemfromEditCursor", "MutedItemRestores", mutedItems)
end

function RestoreMutedItems()
    local mutedItems = getSavedData("InstantSoloItemfromEditCursor", "MutedItemRestores")
...
function SaveSoloTracks()
    ...
    saveData("InstantSoloItemfromEditCursor", "SoloTrackRestores", soloTracks)
end

function RestoreSoloTracks()
    local soloTracks = getSavedData("InstantSoloItemfromEditCursor", "SoloTrackRestores")
